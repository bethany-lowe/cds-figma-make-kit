...
const TOKEN_ROWS = [
  { prop: 'Track background',         token: '--bg-disabled',                  note: 'Muted grey track surface'    },
  { prop: 'Fill — primary',           token: '--bg-primary',                   note: 'Brand primary purple'        },
  { prop: 'Fill — success',           token: '--bg-success',                   note: 'Green'                       },
  { prop: 'Fill — warning',           token: '--bg-alert',                     note: 'Amber / orange'              },
  { prop: 'Fill — error',             token: '--bg-error',                     note: 'Error red'                   },
  { prop: 'Fill — neutral',           token: '--bg-neutral',                   note: 'Neutral grey'                },
  ...
  { prop: 'Label font size',          token: '--body-medium-regular-fontSize', note: 'Regular body'                },
  { prop: 'Value font size',          token: '--body-medium-bold-fontSize',    note: 'Bold body'                   },
  { prop: 'Helper font size',         token: '--body-small-regular-fontSize',  note: 'Small regular'               },
        ...
        <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden">
          ...
          {[
            ...
            },
            {
              ...
              def: '"primary"',
              desc: 'Fill colour conveying the nature or outcome of the process. Maps directly to a CDS semantic background token.',
            },
            {
              prop: 'size',
